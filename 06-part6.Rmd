...
q_name <- sample(c(
    ...
    "For a unit increase in runs, the expected number of homeruns they hit in that season increases by 2681.",
    "For a unit increase in runs, the expected number of homeruns they hit in that season decreases by 2681",
